...
const DEFAULT_HERO = {
  badge: 'New: Website Builder',
  title: 'Create professional websites',
  titleHighlight: 'in minutes, not hours',
  description:
    'Build stunning, responsive websites with our intuitive platform. Perfect for businesses, portfolios, and landing pages.',
  features: [
  ...
  statsLabel2: 'Templates',
  statsValue2: '50+ designs',
} as const;
